...
<a href="index.php"><button style="color: red;">Login</button></a><br><br>
...
<input type="number" name="phonenumber" placeholder=" Enter athlete phone number" class="form-control" required><br><br>
