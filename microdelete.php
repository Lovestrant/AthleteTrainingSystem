...
$id = $_GET['u_id'];
    ...
    include('db.php');
    $sql="SELECT * FROM microscores where phonenumber='$phonenumber' and id = '$id' ORDER BY ID DESC";
...
<form action="microdelete.php" method="post">
...
$sql1="DELETE FROM microscores where id = '$postid'";
