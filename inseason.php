...
<br>
<h4>In-Season Training Program. </h4>
<br>
...
<form class="form-control" action="inseason.php" method="post">
<p>First test</p>
...
if(isset($_POST['postbtn'])){
    ...
    $season = 'inseason';
                    ...
                    while($row = mysqli_fetch_assoc($result)) {
                        ...
                        if($firstscore == 'best' && $secondscore == 'best' && $finalscore == 'best')
                        {
                         echo "<script>alert('You passed the test.Click Ok to proceed to the next level')</script>";
                            ...
                            echo "<script>location.replace('inseason.php')</script>"; 
                        }
		...
		if($res ==1){
            ...
            $sql1="SELECT * FROM microscores where phonenumber = '$phonenumber' Limit 1 and season = '$season'";
