...
<input type="number" name="phonenumber" placeholder="Enter athlete's phone number" class="form-control" required><br>
...
<br><br>
<a href="register.php" style="color: red;">Add new athlete</a>
