...
$id = $_GET['u_id'];
    ...
    include('db.php');
    $sql="SELECT * FROM mesoscores where phonenumber='$phonenumber' and id = '$id' ORDER BY ID DESC";
...
<form action="mesodelete.php" method="post">
...
$sql1="DELETE FROM mesoscores where id = '$postid'";
